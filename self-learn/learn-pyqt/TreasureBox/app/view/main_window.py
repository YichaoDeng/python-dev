...
from ..common import resource  # noqa
...
class MainWindow(FramelessWindow):
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.workInterface, 'workInterface', FIF.DATE_TIME, self.tr('Work Calculator'))

        # add custom widget to bottom
        self.navigationInterface.addWidget(
            routeKey='avatar',
            widget=AvatarWidget(':/gallery/images/yichao.png'),
    ...
    def initWindow(self):
        ...
        self.setWindowIcon(QIcon(':/gallery/images/baibaoxiang.png'))
        self.setWindowTitle('TreasureBox')
